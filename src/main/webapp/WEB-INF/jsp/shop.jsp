							...
							<c:forEach items="${ListProduct}" var="product">
								...
								<div class="col-lg-4 col-md-6 col-sm-6 pb-1 " id="product-item">
									<div class="product-item bg-light mb-4">
										<div
											class="product-img position-relative overflow-hidden py-4">
											<img class="img-fluid w-100"
												src="img/${product.getImgPath()}" alt="">
										...
										<div class="text-center py-4">
											<a class="h5 text-decoration-none text-truncate"
												href="detail?ProductID=${product.getProductID()}">${product.getName()}</a>
											<div
				  ...
				  <li class="page-item"><a class="page-link" onclick="fetchProducts((event),${pageNo+1})">Next</a></li> -->
						...
						<c:if test="${pageNo > 0}">
							<li class="page-item"><a class="page-link"
								onclick="fetchProducts((event),${pageNo-1})">Previous</a></li>
						</c:if>
							...
							<c:choose>
								<c:when test="${pageNum - 1 == pageNo }">
									...
									<li class="page-item"><a class="page-link" href="#"
										onclick="fetchProducts((event),${pageNum - 1})"><strong>${pageNum}</strong></a></li>
								</c:when>
								<c:otherwise>
									<li class="page-item"><a class="page-link" href="#"
										onclick="fetchProducts((event),${pageNum - 1})">${pageNum}</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						...
						<c:if test="${pageNo < totalPage}">
							<li class="page-item"><a class="page-link"
								onclick="fetchProducts((event),${pageNo+1})">Next</a></li>
						</c:if>
